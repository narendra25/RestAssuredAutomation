...
public class GetRepoDetails extends SpecUtils {
	...
	String accessToken = "";
	private static final Logger LOG = LogManager.getLogger(GetRepoDetails.class);
	@Before
...
@When("User send Post request using get Repository Details Api {string}  {int}")
